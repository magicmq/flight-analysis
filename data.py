...
def transform_data(data):
    ...
    def _transform_data(_data):
        ...
        flight_no_order = ['7', '143', '32', '39', '837', '875', '881', '803', '131', '79', '35']
        ...
        route_order = ['UAL7 (IAH-NRT)', 'UAL143 (DEN-NRT)', 'UAL32 (LAX-NRT)', 'UAL39 (LAX-HND)', 'UAL837 (SFO-NRT)', 'UAL875 (SFO-HND)', 'UAL881 (ORD-HND)', 'UAL803 (IAD-HND)', 'UAL131 (EWR-HND)', 'UAL79 (EWR-NRT)', 'UAL35 (SFO-KIX)']
        ...
        _data['p_sy_ug_bu_net'] = _data['p_sy_ug_bu'] - _data['p_sy_ug_bu_nci']
        _data['p_sy_ug_co_net'] = _data['p_sy_ug_co'] - _data['p_sy_ug_co_nci']
        _data['p_sy_ug_pp_net'] = _data['p_sy_ug_pp'] - _data['p_sy_ug_pp_nci']
        _data['p_sy_sa_bu_net'] = _data['p_sy_sa_bu'] - _data['p_sy_sa_bu_nci']
        _data['p_sy_sa_co_net'] = _data['p_sy_sa_co'] - _data['p_sy_sa_co_nci']
        _data['p_sy_sa_pp_net'] = _data['p_sy_sa_pp'] - _data['p_sy_sa_pp_nci']
        _data['p_sy_to_bu_net'] = _data['p_sy_to_bu'] - _data['p_sy_to_bu_nci']
        _data['p_sy_to_co_net'] = _data['p_sy_to_co'] - _data['p_sy_to_co_nci']
        _data['p_sy_to_pp_net'] = _data['p_sy_to_pp'] - _data['p_sy_to_pp_nci']
        ...
        _data['p_sy_to_to_nci'] = _data['p_sy_to_bu_nci'] + _data['p_sy_to_co_nci'] + _data['p_sy_to_pp_nci']
        _data['p_sy_ug_to_nci'] = _data['p_sy_ug_bu_nci'] + _data['p_sy_ug_co_nci'] + _data['p_sy_ug_pp_nci']
        _data['p_sy_sa_to_nci'] = _data['p_sy_sa_bu_nci'] + _data['p_sy_sa_co_nci'] + _data['p_sy_sa_pp_nci']

        _data['p_sy_to_to_net'] = _data['p_sy_to_bu_net'] + _data['p_sy_to_co_net'] + _data['p_sy_to_pp_net']
        _data['p_sy_ug_to_net'] = _data['p_sy_ug_bu_net'] + _data['p_sy_ug_co_net'] + _data['p_sy_ug_pp_net']
        _data['p_sy_sa_to_net'] = _data['p_sy_sa_bu_net'] + _data['p_sy_sa_co_net'] + _data['p_sy_sa_pp_net']
